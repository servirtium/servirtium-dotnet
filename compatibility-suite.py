...
if len(sys.argv) > 1:
    ...
    if sys.argv[1] == "record":
        ...
        servirtium_process = subprocess.Popen(["dotnet", "Servirtium.StandaloneServer/bin/Debug/netcoreapp3.1/Servirtium.StandaloneServer.dll", "record", realUrl], stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
    elif sys.argv[1] == "playback":
        url = "http://localhost:61417"
        servirtium_process = subprocess.Popen(["dotnet", "Servirtium.StandaloneServer/bin/Debug/netcoreapp3.1/Servirtium.StandaloneServer.dll", "playback", realUrl], stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
