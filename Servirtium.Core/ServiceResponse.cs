...
namespace Servirtium.Core
{
    public class ServiceResponse : IResponseMessage
    {
        ...
        public ServiceResponse(byte[]? body, MediaTypeHeaderValue? contentType, HttpStatusCode statusCode, IEnumerable<(string, string)> headers)
        {
            Headers = headers;
            Body = body;
        ...
        public ServiceResponse(byte[]? body, MediaTypeHeaderValue? contentType, HttpStatusCode statusCode, params (string, string)[] headers) : this(body, contentType, statusCode, (IEnumerable<(string, string)>)headers) { }
        ...
        public ServiceResponse WithRevisedBody(string body, bool createContentLengthHeader = false) => WithRevisedBody(UTF8Encoding.UTF8.GetBytes(body), createContentLengthHeader);

        public ServiceResponse WithRevisedBody(byte[] body, bool createContentLengthHeader = false)
        {
        ...
        public ServiceResponse WithReadjustedContentLength() => Body != null ? WithRevisedBody(Body) : this;
