...
namespace Servirtium.Core
{
    public class InteractionRecordingServirtiumRequestHandler : IServirtiumRequestHandler
    {
        ...
        private readonly IInteractionTransforms _transforms;

        private readonly IInteractionMonitor _monitor;

        public InteractionRecordingServirtiumRequestHandler(IInteractionTransforms transforms, IInteractionMonitor monitor)
        {
